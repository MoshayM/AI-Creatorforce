...
function ChannelAccessContent() {
  ...
  useEffect(() => {
    if (justConnected) {
      ...
      window.history.replaceState({}, '', '/channel-access');
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-10">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Channel Access</h1>
        <p className="text-gray-500 mt-1 text-sm">Manage every channel and social account AI CreatorForce can publish to — all in one panel</p>
      </div>
