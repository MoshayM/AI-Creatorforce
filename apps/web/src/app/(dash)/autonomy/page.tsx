  ...
  return (
    <div className="min-h-full bg-[#faf9ff]">
      <div className="p-5 lg:p-7 max-w-5xl mx-auto space-y-5">
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div>
            <h1 className="text-2xl font-extrabold text-gray-900 leading-tight flex items-center gap-2">
              <Sparkles className="w-6 h-6" style={{ color: '#6D4AE0' }} />
              Autonomy
            </h1>
        ...
        {channelId && (
          <div className="flex bg-gray-100 rounded-2xl p-1">
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-xl transition-colors ${insightsTab === 'planner' ? 'bg-white shadow text-[#6D4AE0]' : 'text-gray-500 hover:text-gray-700'}`}
            >
            ...
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-xl transition-colors ${insightsTab === 'insights' ? 'bg-white shadow text-[#6D4AE0]' : 'text-gray-500 hover:text-gray-700'}`}
            >
            ...
            <button
              ...
              className={`flex-1 py-2 text-sm font-medium rounded-xl transition-colors ${insightsTab === 'log' ? 'bg-white shadow text-[#6D4AE0]' : 'text-gray-500 hover:text-gray-700'}`}
            >
        ...
        {!channelId && (
          <div className="flex flex-col items-center justify-center text-gray-500 py-20 bg-white rounded-3xl" style={{ border: '1.5px solid #e3ddf8' }}>
          ...
          <>
            ...
            <section>
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
                  <BarChart3 className="w-5 h-5" style={{ color: '#6D4AE0' }} />
                  Channel Profile
                </h2>
                <button
                  type="button"
            ...
            {stats && stats.total > 0 && (
              <section className="bg-white rounded-2xl px-5 py-4" style={{ border: '1.5px solid #e3ddf8' }}>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {stats.approved > 0 && (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium" style={{ background: '#ecfdf5', color: '#065f46', border: '1px solid #a7f3d0' }}>
                      <Check className="w-3 h-3" /><span className="font-bold">{stats.approved}</span> approved
                    </span>
                  )}
                  {stats.dismissed > 0 && (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium" style={{ background: '#f3f4f6', color: '#4b5563', border: '1px solid #e5e7eb' }}>
                      <X className="w-3 h-3" /><span className="font-bold">{stats.dismissed}</span> dismissed
                    </span>
                  )}
                  {stats.upcoming7d > 0 && (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium" style={{ background: '#f5f2fd', color: '#6D4AE0', border: '1px solid #e3ddf8' }}>
                  ...
                  {stats.avgPriority !== null && (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium" style={{ background: '#fff7ed', color: '#c2410c', border: '1px solid #fed7aa' }}>
            ...
            <section className="bg-white rounded-2xl p-5" style={{ border: '1.5px solid #e3ddf8' }}>
              <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2 mb-1">
                <CalendarClock className="w-5 h-5" style={{ color: '#6D4AE0' }} />
              ...
              {critique && (
                <div className="mt-4 flex items-start gap-2 text-sm text-gray-600 rounded-2xl px-4 py-3" style={{ background: '#f5f2fd', border: '1.5px solid #e3ddf8' }}>
            ...
            <section>
              ...
              <div className="space-y-2">
                {proposed.map((e) => (
                  <div key={e.id} className={`bg-white rounded-2xl p-4 flex items-center gap-4 transition-colors ${selected.has(e.id) ? '' : ''}`} style={{ border: selected.has(e.id) ? '1.5px solid #6D4AE0' : '1.5px solid #e3ddf8', background: selected.has(e.id) ? '#faf9ff' : '#fff' }}>
                    <input
                      type="checkbox"
              ...
              {approved.length > 0 && (
                <>
                  ...
                  <div className="space-y-1.5">
                    {approved.map((e) => (
                      <div key={e.id} className="flex items-center gap-3 text-sm text-gray-600 rounded-2xl px-3 py-2" style={{ background: '#ecfdf5', border: '1.5px solid #a7f3d0' }}>
          ...
          <div className="space-y-5">
            ...
            {stats && (
              <section className="bg-white rounded-2xl p-5" style={{ border: '1.5px solid #e3ddf8' }}>
                <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2 mb-4">
                  <ListChecks className="w-5 h-5" style={{ color: '#6D4AE0' }} />
            ...
            {stats && (() => {
              ...
              return (
                <section className="bg-white rounded-2xl p-5" style={{ border: '1.5px solid #e3ddf8' }}>
                  <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2 mb-4">
                    <Target className="w-5 h-5" style={{ color: '#6D4AE0' }} />
            ...
            <section className="bg-white rounded-2xl p-5" style={{ border: '1.5px solid #e3ddf8' }}>
              <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2 mb-4">
                <TrendingUp className="w-5 h-5" style={{ color: '#6D4AE0' }} />
              ...
              {channels.length <= 1 ? (
                ...
                <div className="space-y-3">
                  ...
                  {crossChannel.insights.map((insight, i) => (
                    <div key={i} className={`flex items-start gap-3 p-4 rounded-2xl`} style={
                      insight.priority === 'high'
                        ? { border: '1.5px solid #e3ddf8', background: '#f5f2fd' }
                        : insight.priority === 'medium'
                        ? { border: '1.5px solid #bfdbfe', background: '#eff6ff' }
                        : { border: '1.5px solid #e5e7eb', background: '#f9fafb' }
                    }>
                      <span className="text-xs px-2 py-0.5 rounded-full font-semibold shrink-0 mt-0.5" style={
                        insight.priority === 'high'
                          ? { background: '#e3ddf8', color: '#6D4AE0' }
                          : insight.priority === 'medium'
            ...
            <section className="bg-white rounded-2xl p-5" style={{ border: '1.5px solid #e3ddf8' }}>
              ...
              <p className="text-sm text-gray-400 mb-4">Improve future AI predictions by reporting actual video results. This feeds the performance feedback loop.</p>
        ...
        {selected.size > 0 && (
          <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-white rounded-full px-5 py-3 shadow-xl" style={{ border: '1.5px solid #e3ddf8' }}>
